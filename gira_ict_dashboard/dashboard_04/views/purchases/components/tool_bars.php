<div class="grid grid-cols-2 mt-10 items-center">
    <div>
        <form action="purchases.php" method="post">
            <div class="input-group">
                <input type="text" class="form-control rounded-0" required placeholder="Search purchase..." name="product_search_name">
    ...
    <div class="flex justify-end items-center gap-3">
        <div class="nav-item dropdown w-20">
            ...
            <form action="purchases.php" method="post" class="dropdown-menu dropdown-menu-end bg-light  m-0 border rounded text-dark" style="z-index: 111111;">
        ...
        <div class=" bg-[#D22127]">
            <a href="purchases.php" class="nav-link   border  rounded"  > 
