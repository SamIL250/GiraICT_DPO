...
<div class="container-fluid pt-4 px-4 relative">
    <div class="">
        <div class="grid grid-cols-12 items-center ">
            <div class="col-span-6">
                <p class="text-3xl">Product Categories</p>
            </div> 
        </div>
    </div>
    ...
    <!-- Add btn -->
    <div  class="btn btn-lg bg-black text-white text-3xl font-bold btn-lg-square fixed bottom-3 mb-16 right-12 shadow "  data-bs-toggle="modal" data-bs-target="#formModal">+</div>
