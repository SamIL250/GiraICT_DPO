<?php
    ...
    if(isset($_GET['canceled_order']) && isset($_GET['order_user_id'])) {
        ...
        $update_order_status = mysqli_query($conn, "UPDATE orders SET canceled = 'false' WHERE order_id = '$canceled_order_id'"); 
        
        if($update_order_status) {
            $_SESSION['canceled_order_message'] = "Your order has been re-ordered.";
