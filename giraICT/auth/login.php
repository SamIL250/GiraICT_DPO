        ...
        <div>
            <div class="container py-3 auth-main-container">
                <div class="grid grid-cols-12 gap-3">
                    <div class="carouser-section col-span-6 relative border p-3 rounded grid grid-cols-1 items-center">
                        <div class="min-h-10 bg-[#F5ED4D] sticky top-0 border rounded shadow-sm flex items-center p-2 justify-between">
                            ...
                            <a href="register.php">
                                <button class="button btn border rounded  bg-black text-white hover:text-white transition px-4">Create Account</button>
                            </a>
                        ...
                        <div class="py-16 px-20">
                            ...
                            <div>
                                <form action="./services/login.php" method="post">
                                    ...
                                    <div class="pb-3">
                                        <button class="w-100 border rounded py-2 bg-[#F5ED4D]" name="login">Login</button>
                                    </div>
                                    <div class="pb-3">
                                        <a href="../index.php" class="w-100 border btn rounded py-2 bg-black text-white" name="login">Continue without Login</a>
                                    </div>
                                    ...
                                    <div class="grid grid-cols-1 gap-5">
                                        <div class="border text-center rounded py-2" style="">
